...
contract Esquid is ERC20, Ownable {

    address public _minterWallet = 0xDfbE21E3E274ea73Ee4402EDeC1c3C39503e3E56;


    constructor() ERC20("Esquid", "$QUID") {
        _mint(msg.sender, 15000000 * 10 ** decimals());
    }

    function mint(uint256 _amount) public {
        require(msg.sender == _minterWallet, "Only minter wallet can call this function");
